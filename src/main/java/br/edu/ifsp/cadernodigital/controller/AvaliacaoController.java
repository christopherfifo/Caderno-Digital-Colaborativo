...
public class AvaliacaoController {
  ...
  public AvaliacaoResponse avaliarMidia(
  ...
  public List<AvaliacaoResponse> listarAvaliacoesDaMidia(
    @PathVariable Long midiaId
  ) {
    Midia midia = buscarMidia(midiaId);
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public AvaliacaoResponse avaliarComentario(
  ...
  public List<AvaliacaoResponse> listarAvaliacoesDoComentario(
    @PathVariable Long comentarioId
  ) {
    Comentario comentario = buscarComentario(comentarioId);

    return avaliacaoRepository
      .findByComentarioAvaliado(comentario)
      .stream()
      .map(AvaliacaoResponse::fromEntity)
      .toList();
  }

  private void pontuarAvaliacao(
    Usuario avaliador,
    Usuario autorAvaliado,
    Integer nota
  ) {
