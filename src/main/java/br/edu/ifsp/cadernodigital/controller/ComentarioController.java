...
public class ComentarioController {
  ...
  public List<ComentarioResponse> listarComentariosDaMidia(
    @PathVariable Long midiaId
  ) {
    Midia midia = buscarMidia(midiaId);

    return comentarioRepository
      .findByMidiaAndComentarioPaiIsNullOrderByCriadoEmAsc(midia)
      .stream()
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ComentarioResponse responder(
  ...
  public List<ComentarioResponse> listarRespostas(
    @PathVariable Long comentarioId
  ) {
    Comentario comentarioPai = buscarComentario(comentarioId);

    return comentarioRepository
      .findByComentarioPaiOrderByCriadoEmAsc(comentarioPai)
      .stream()
      .map(ComentarioResponse::fromEntity)
      .toList();
  }
