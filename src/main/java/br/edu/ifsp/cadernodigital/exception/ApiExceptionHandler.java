...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ErroResponse> tratarNaoEncontrado(RecursoNaoEncontradoException exception) {
        return ResponseEntity
                ...
                .body(ErroResponse.criar(404, exception.getMessage()));
    }

    @ExceptionHandler(IllegalArgumentException.class)
    public ResponseEntity<ErroResponse> tratarRegraInvalida(IllegalArgumentException exception) {
        return ResponseEntity
                .badRequest()
                .body(ErroResponse.criar(400, exception.getMessage()));
    }
    ...
    public ResponseEntity<ErroResponse> tratarValidacao(MethodArgumentNotValidException exception) {
        ...
        return ResponseEntity
                .badRequest()
                .body(ErroResponse.criar(400, mensagem));
    }
}
